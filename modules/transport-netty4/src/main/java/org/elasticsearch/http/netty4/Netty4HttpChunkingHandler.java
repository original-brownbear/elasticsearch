 ...
 */
public final class Netty4HttpChunkingHandler extends ChannelDuplexHandler {
    ...
    public Netty4HttpChunkingHandler(ThreadContext threadContext) {
    ...
    public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) {
        ...
        final boolean queued = queuedWrites.offer(new WriteOperation((HttpContent) msg, promise));
        assert queued;
    }
    ...
    private record WriteOperation(HttpContent message, ChannelPromise promise) {
