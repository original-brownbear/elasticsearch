...
public class ReindexBasicTests extends ReindexTestCase {
    public void testFiltering() throws Exception {
        ...
        assertHitCount(4, prepareSearch("dest").setSize(0));
        ...
        assertHitCount(0, prepareSearch("none").setSize(0));
    ...
    public void testCopyMany() throws Exception {
        ...
        assertHitCount(max, prepareSearch("source").setSize(0));
        ...
        assertHitCount(max, prepareSearch("dest").setSize(0));
        ...
        assertHitCount(half, prepareSearch("dest_half").setSize(0));
    }
    ...
    public void testCopyManyWithSlices() throws Exception {
        ...
        assertHitCount(response.getCreated(), prepareSearch("dest_half").setSize(0));
    }
    ...
    public void testMultipleSources() throws Exception {
        ...
        assertHitCount(allDocs.size(), prepareSearch("dest").setSize(0));
    }
    ...
    public void testReindexFromComplexDateMathIndexName() throws Exception {
        ...
        assertHitCount(4, prepareSearch(sourceIndexName).setSize(0));

        // Copy all the docs
        ReindexRequestBuilder copy = reindex().source(sourceIndexName).destination(destIndexName).refresh(true);
        assertThat(copy.get(), matcher().created(4));
        assertHitCount(4, prepareSearch(destIndexName).setSize(0));
    }
