...
public class BlobStoreCacheServiceTests extends ESTestCase {
    ...
    public void testGetWhenServiceNotStarted() {
        doAnswer(invocation -> {
            ...
            return null;
        }).when(mockClient).execute(eq(TransportGetAction.ACTION_TYPE), any(GetRequest.class), any(ActionListener.class));
    ...
    public void testPutWhenServiceNotStarted() {
        doAnswer(invocation -> {
            ...
            return null;
        }).when(mockClient).execute(eq(TransportIndexAction.ACTION_TYPE), any(IndexRequest.class), any(ActionListener.class));
