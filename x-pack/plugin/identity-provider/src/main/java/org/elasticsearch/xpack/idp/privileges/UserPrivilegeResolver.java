...
public class UserPrivilegeResolver {
    ...
    public void resolve(ServiceProviderPrivileges service, ActionListener<UserPrivileges> listener) {
        buildResourcePrivilege(service, listener.wrap((resourcePrivilege, l) -> {
            ...
            client.execute(HasPrivilegesAction.INSTANCE, request, l.wrap((response, ll) -> {
    ...
    private void buildResourcePrivilege(ServiceProviderPrivileges service,
        ...
        actionsResolver.getActions(service.getApplicationName(), listener.wrap((actions, l) -> {
