...
public class TransportPutSamlServiceProviderAction
    ...
    protected void doExecute(Task task, final PutSamlServiceProviderRequest request,
        ...
        index.findByEntityId(document.entityId, listener.wrap((matchingDocuments, l) -> {
            if (matchingDocuments.isEmpty()) {
                ...
                writeDocument(document, DocWriteRequest.OpType.CREATE, request.getRefreshPolicy(), l);
                ...
                writeDocument(document, DocWriteRequest.OpType.INDEX, request.getRefreshPolicy(), l);
            } else {
    ...
    private void writeDocument(SamlServiceProviderDocument document, DocWriteRequest.OpType opType,
        ...
        index.writeDocument(document, opType, refreshPolicy, listener.wrap((response, l) -> l.onResponse(
