...
public class AutoscalingNodesInfoServiceTests extends AutoscalingTestCase {
    ...
    private class NodeStatsClient extends NoOpClient {
        ...
        protected <Request extends ActionRequest, Response extends ActionResponse> void doExecute(
            ...
            assertThat(
                action,
                anyOf(Matchers.sameInstance(TransportNodesStatsAction.ACTION), Matchers.sameInstance(TransportNodesInfoAction.ACTION))
            );
            if (action == TransportNodesStatsAction.ACTION) {
