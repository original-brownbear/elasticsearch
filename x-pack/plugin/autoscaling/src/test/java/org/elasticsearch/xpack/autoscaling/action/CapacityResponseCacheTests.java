...
public class CapacityResponseCacheTests extends AutoscalingTestCase {
    ...
    public void testSingleResponse() throws ExecutionException, InterruptedException {
        ...
        cache.get(FunctionUtils.FALSE_BOOLEAN_SUPPLIER, future);
    ...
    public void testMultipleRequests() throws Exception {
        ...
        for (int i = 0; i < count; ++i) {
            ...
            maybeSpawn.accept(() -> cache.get(FunctionUtils.FALSE_BOOLEAN_SUPPLIER, blockingFuture));
        ...
        cache.get(FunctionUtils.FALSE_BOOLEAN_SUPPLIER, responseFuture);
    ...
    public void testMultipleRequestsCancelled() throws Exception {
        ...
        PlainActionFuture<Integer> blockingFuture = new PlainActionFuture<>();
        cache.get(FunctionUtils.FALSE_BOOLEAN_SUPPLIER, blockingFuture);
        await(barrier);
    ...
    public void testThreadPoolExhausted() throws Exception {
        ...
        runOnThread.accept(() -> { cache.get(FunctionUtils.FALSE_BOOLEAN_SUPPLIER, future1); });
        await(barrier);
        PlainActionFuture<Integer> future2 = new PlainActionFuture<>();
        cache.get(FunctionUtils.FALSE_BOOLEAN_SUPPLIER, future2);
