...
public class WatcherInfoTransportActionTests extends ESTestCase {
    ...
    public void testUsageStats() throws Exception {
        ...
        XPackFeatureSetUsage serializedUsage = new WatcherFeatureSetUsage(out.bytes().streamInput());

        for (XPackFeatureSetUsage usage : Arrays.asList(watcherUsage, serializedUsage)) {
