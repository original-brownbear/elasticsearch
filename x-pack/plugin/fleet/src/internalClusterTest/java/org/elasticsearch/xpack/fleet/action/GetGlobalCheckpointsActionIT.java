...
public class GetGlobalCheckpointsActionIT extends ESIntegTestCase {
    ...
    public void testPollGlobalCheckpointAdvancement() throws Exception {
        ...
        client().admin()
            .indices()
            .prepareCreate(indexName)
            .setSettings(shardsAndReplicas(1, 1).put(IndexSettings.INDEX_TRANSLOG_DURABILITY_SETTING.getKey(), Translog.Durability.REQUEST))
            .get();
    ...
    public void testPollGlobalCheckpointAdvancementTimeout() {
        ...
        client().admin()
            .indices()
            .prepareCreate(indexName)
            .setSettings(shardsAndReplicas(1, 0).put(IndexSettings.INDEX_TRANSLOG_DURABILITY_SETTING.getKey(), Translog.Durability.REQUEST))
            .get();
    ...
    public void testWaitForAdvanceOnlySupportsOneShard() {
        ...
        client().admin()
            .indices()
            .prepareCreate(indexName)
            .setSettings(shardsAndReplicas(3, 0).put(IndexSettings.INDEX_TRANSLOG_DURABILITY_SETTING.getKey(), Translog.Durability.REQUEST))
            .get();
    ...
    public void testPrimaryShardsNotReadyNoWait() {
        ...
        client().admin()
            ...
            .setSettings(
                shardsAndReplicas(1, 0).put(IndexSettings.INDEX_TRANSLOG_DURABILITY_SETTING.getKey(), Translog.Durability.REQUEST)
