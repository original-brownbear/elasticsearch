...
public class TransportPutInternalRepositoryAction extends TransportAction<PutInternalCcrRepositoryRequest, ActionResponse.Empty> {

    public static final ActionType<ActionResponse.Empty> ACTION = ActionType.empty("internal:admin/ccr/internal_repository/put");
