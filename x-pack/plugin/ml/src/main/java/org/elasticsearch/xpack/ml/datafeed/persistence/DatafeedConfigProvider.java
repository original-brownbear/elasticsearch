...
public class DatafeedConfigProvider {
    ...
    public void getDatafeedConfig(
        ...
        executeAsyncWithOrigin(client, ML_ORIGIN, TransportGetAction.ACTION_TYPE, getRequest, new ActionListener<GetResponse>() {
            @Override
    ...
    private void indexUpdatedConfig(DatafeedConfig updatedConfig, long seqNo, long primaryTerm, ActionListener<IndexResponse> listener) {
        try (XContentBuilder builder = XContentFactory.jsonBuilder()) {
            ...
            executeAsyncWithOrigin(client, ML_ORIGIN, TransportIndexAction.ACTION_TYPE, indexRequest, listener);
