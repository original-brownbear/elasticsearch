...
public class CleanupTargetIndexStepTests extends AbstractStepTestCase<CleanupTargetIndexStep> {
    ...
    public CleanupTargetIndexStep mutateInstance(CleanupTargetIndexStep instance) {
        ...
        switch (between(0, 3)) {
            ...
            case 2 -> sourceIndexNameSupplier = (indexMetadata) -> randomAlphaOfLengthBetween(11, 15) + indexMetadata.getIndex().name();
            case 3 -> targetIndexNameSupplier = (indexMetadata) -> randomAlphaOfLengthBetween(11, 15) + indexMetadata.getIndex().name();
