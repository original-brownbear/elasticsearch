...
public class AbstractAuditorTests extends ESTestCase {
    ...
    public void testInfo() throws IOException {
        ...
        verify(client).execute(eq(TransportIndexAction.ACTION_TYPE), indexRequestCaptor.capture(), any());
    ...
    public void testAuditingBeforeTemplateInstalled() throws Exception {
        ...
        verify(client, never()).execute(eq(TransportIndexAction.ACTION_TYPE), any(), any());
        ...
        verify(client, times(1)).execute(eq(TransportIndexAction.ACTION_TYPE), any(), any());
    }
