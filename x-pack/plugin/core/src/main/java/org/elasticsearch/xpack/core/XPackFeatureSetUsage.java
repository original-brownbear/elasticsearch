...
public abstract class XPackFeatureSetUsage implements ToXContentObject, VersionedNamedWriteable {
    ...
    public XPackFeatureSetUsage(StreamInput input) throws IOException {
        this(input.readString(), input.readBoolean(), input.readBoolean());
    }

    public XPackFeatureSetUsage(String name, boolean available, boolean enabled) {
