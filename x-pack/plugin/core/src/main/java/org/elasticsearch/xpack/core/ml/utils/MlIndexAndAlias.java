...
public final class MlIndexAndAlias {
    ...
    public static void createIndexAndAliasIfNecessary(Client client,
        ...
        ActionListener<Boolean> indexCreatedListener = loggingListener.wrap(
            created -> {
                if (created) {
    ...
    public static void createSystemIndexIfNecessary(Client client,
        ...
        executeAsyncWithOrigin(client.threadPool().getThreadContext(), ML_ORIGIN, createIndexRequest,
                indexCreatedListener.<CreateIndexResponse>wrap(
                        r -> indexCreatedListener.onResponse(r.isAcknowledged())), client.admin().indices()::create);
    }
    ...
    private static void waitForShardsReady(Client client, String index, ActionListener<Boolean> listener) {
        ...
        executeAsyncWithOrigin(
            ...
            ML_ORIGIN,
            healthRequest, listener.<ClusterHealthResponse>wrap(response -> listener.onResponse(response.isTimedOut() == false)),
    ...
    private static void updateWriteAlias(Client client,
        ...
        executeAsyncWithOrigin(client.threadPool().getThreadContext(),
            ML_ORIGIN,
            request,
            listener.<AcknowledgedResponse>wrap(resp -> listener.onResponse(resp.isAcknowledged())),
    ...
    public static void installIndexTemplateIfRequired(
        ...
        ActionListener<AcknowledgedResponse> innerListener = listener.wrap(response -> {
