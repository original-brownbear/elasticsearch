...
public class TextStructure implements ToXContentObject, Writeable {
    ...
    public TextStructure(StreamInput in) throws IOException {
        ...
        columnNames = in.readBoolean() ? in.readImmutableStringList() : null;
        ...
        jodaTimestampFormats = in.readBoolean() ? in.readImmutableStringList() : null;
        javaTimestampFormats = in.readBoolean() ? in.readImmutableStringList() : null;
        ...
        explanation = in.readImmutableStringList();
    }
