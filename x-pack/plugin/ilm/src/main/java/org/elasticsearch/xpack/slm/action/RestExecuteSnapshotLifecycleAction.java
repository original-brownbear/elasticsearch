...
public class RestExecuteSnapshotLifecycleAction extends BaseRestHandler {
    ...
    public List<Route> routes() {
        return List.of(new Route(POST, "/_slm/policy/{name}/_execute"), new Route(PUT, "/_slm/policy/{name}/_execute"));
    }
    ...
    protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) {
        ...
        ExecuteSnapshotLifecycleAction.Request req = new ExecuteSnapshotLifecycleAction.Request(snapLifecycleId).parseTimeoutParams(
            request
        );
