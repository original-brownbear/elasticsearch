...
public class PermissionTests extends ESTestCase {
    ...
    public void testAllowedIndicesMatcherAction() throws Exception {
        testAllowedIndicesMatcher(permission.indices().allowedIndicesMatcher(TransportGetAction.NAME));
    }
    ...
    public void testAllowedIndicesMatcherActionCaching() throws Exception {
        IsResourceAuthorizedPredicate matcher1 = permission.indices().allowedIndicesMatcher(TransportGetAction.NAME);
        IsResourceAuthorizedPredicate matcher2 = permission.indices().allowedIndicesMatcher(TransportGetAction.NAME);
