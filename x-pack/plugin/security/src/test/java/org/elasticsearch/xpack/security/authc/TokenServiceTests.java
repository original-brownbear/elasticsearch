...
public class TokenServiceTests extends ESTestCase {
    ...
    public void setupClient() {
        ...
        when(client.prepareIndex(any(String.class))).thenReturn(new IndexRequestBuilder(client, TransportIndexAction.ACTION_TYPE));
        ...
        when(client.prepareUpdate(any(String.class), any(String.class))).thenAnswer(inv -> {
            ...
            return new UpdateRequestBuilder(client, TransportUpdateAction.ACTION_TYPE).setIndex(index).setId(id);
        });
