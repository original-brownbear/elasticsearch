...
public class ElasticsearchException extends RuntimeException implements ToXContentFragment, Writeable {
    ...
    public ElasticsearchException(StreamInput in) throws IOException {
        ...
        headers.putAll(in.readImmutableMapWithoutNulls(StreamInput::readString, StreamInput::readStringList));
        metadata.putAll(in.readImmutableMapWithoutNulls(StreamInput::readString, StreamInput::readStringList));
    }
