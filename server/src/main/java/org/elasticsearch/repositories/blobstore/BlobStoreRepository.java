...
public abstract class BlobStoreRepository extends AbstractLifecycleComponent implements Repository {
    ...
    private void doDeleteShardSnapshots(Collection<SnapshotId> snapshotIds, long repositoryStateId, Map<String, BlobContainer> foundIndices,
        ...
        if (SnapshotsService.useShardGenerations(repoMetaVersion)) {
            ...
            writeIndexGen(updatedRepoData, repositoryStateId, repoMetaVersion, Function.identity(), listener.wrap((newRepoData, l) -> {
                ...
                writeMetaAndComputeDeletesStep.addListener(afterCleanupsListener.wrap(deleteResults ->
    ...
    private void writeUpdatedShardMetaDataAndComputeDeletes(Collection<SnapshotId> snapshotIds, RepositoryData oldRepositoryData,
        ...
        for (IndexId indexId : indices) {
            ...
            shardCountListener.addListener(deleteIndexMetadataListener.wrap(counts -> {
    ...
    public void snapshotShard(Store store, MapperService mapperService, SnapshotId snapshotId, IndexId indexId,
        ...
        try {
            ...
            allFilesUploadedListener.addListener(listener.wrap(v -> {
