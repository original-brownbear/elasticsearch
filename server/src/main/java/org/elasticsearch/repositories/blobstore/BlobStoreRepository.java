        ...
        try {
            ...
            if (survivingIndexIds.equals(foundIndices.keySet()) && staleRootBlobs.isEmpty()) {
                ...
                writeIndexGen(repositoryData, repositoryStateId, repositoryMetaVersion,
                        Function.identity(), listener.wrap((v, l) -> cleanupStaleBlobs(Collections.emptyList(), foundIndices, rootBlobs,
                                repositoryData, l.map(RepositoryCleanupResult::new))));
            }
        } catch (Exception e) {
        ...
        while (true) {
            ...
            try {
                ...
                if (bestEffortConsistency == false && ExceptionsHelper.unwrap(e, NoSuchFileException.class) != null) {
                    ...
                    markRepoCorrupted(genToLoad, e, listener.wrap((v, l) -> l.onFailure(corruptedStateException(e))));
                } else {
                    listener.onFailure(e);
                }
                return;
