...
public interface Repository extends LifecycleComponent {
     ...
     * @param repositoryData the RepositoryData of the repo at the time the snapshot was started
     */
    void initializeSnapshot(SnapshotId snapshotId, List<IndexId> indices, MetaData metaData, RepositoryData repositoryData);
     ...
     *
     * @param snapshotId snapshot id
     * @param repositoryData the RepositoryData from the time the deletion was started
     * @param listener completion listener
     */
    void deleteSnapshot(SnapshotId snapshotId, RepositoryData repositoryData, ActionListener<Void> listener);
