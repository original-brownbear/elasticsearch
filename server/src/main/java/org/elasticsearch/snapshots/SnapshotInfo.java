...
public final class SnapshotInfo implements Comparable<SnapshotInfo>, ToXContentFragment, Writeable {
    ...
    public static SnapshotInfo readFrom(final StreamInput in) throws IOException {
        ...
        final List<SnapshotShardFailure> shardFailures = in.readImmutableListOfNonNull(SnapshotShardFailure::new);
        ...
        final List<SnapshotFeatureInfo> featureStates = in.readImmutableListOfNonNull(SnapshotFeatureInfo::new);
