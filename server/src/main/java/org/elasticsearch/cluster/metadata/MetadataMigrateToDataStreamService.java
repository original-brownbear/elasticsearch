...
public class MetadataMigrateToDataStreamService {
    ...
    public void migrateToDataStream(
        ...
        ActionListener<AcknowledgedResponse> listener = ActionListener.wrap(finalListener, (wrapper, response) -> {
            if (response.isAcknowledged()) {
                ...
                activeShardsObserver.waitForActiveShards(
                    ...
                    shardsAcked -> { wrapper.onResponse(AcknowledgedResponse.TRUE); },
                    wrapper::onFailure
                );
            } else {
                wrapper.onResponse(AcknowledgedResponse.FALSE);
            }
        });
