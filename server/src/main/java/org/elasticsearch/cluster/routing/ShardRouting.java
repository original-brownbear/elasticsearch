...
public final class ShardRouting implements Writeable, ToXContentObject {
    ...
    public ShardRouting(ShardId shardId, StreamInput in) throws IOException {
        this.shardId = shardId;
        currentNodeId = DiscoveryNode.deduplicator.deduplicateAllowNull(in.readOptionalString());
        relocatingNodeId = DiscoveryNode.deduplicator.deduplicateAllowNull(in.readOptionalString());
