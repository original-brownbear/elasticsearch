...
public class NodeShutdownAllocationDecider extends AllocationDecider {
    ...
    public Decision canAllocate(ShardRouting shardRouting, RoutingNode node, RoutingAllocation allocation) {
        final SingleNodeShutdownMetadata thisNodeShutdownMetadata = allocation.nodesShutdownMetadata()
    ...
    public Decision shouldAutoExpandToNode(IndexMetadata indexMetadata, DiscoveryNode node, RoutingAllocation allocation) {
        SingleNodeShutdownMetadata thisNodeShutdownMetadata = allocation.nodesShutdownMetadata().getAllNodeMetadataMap().get(node.getId());
