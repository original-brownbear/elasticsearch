 ...
 * <p>
 * The index requires the {@link #index()}, {@link #id(BytesReference)} and
 ...
 * <p>
 * If the {@link #id(BytesReference)} is not set, it will be automatically generated.
 *
 * @see IndexResponse
...
public class IndexRequest extends ReplicatedWriteRequest<IndexRequest> implements DocWriteRequest<IndexRequest>, CompositeIndicesRequest {
    ...
    public IndexRequest(@Nullable ShardId shardId, StreamInput in) throws IOException {
        ...
        id = in.readOptionalBytesReference();
     ...
     */
    public IndexRequest id(BytesReference id) {
        this.id = id;
        return this;
    }
     ...
     */
    @Override
    public IndexRequest routing(BytesReference routing) {
    ...
    public void autoGenerateId() {
        ...
        id(new BytesArray(UUIDs.base64UUID()));
    }
    ...
    private void writeBody(StreamOutput out) throws IOException {
        ...
        out.writeOptionalBytesReference(id);
    ...
    public long ramBytesUsed() {
        return SHALLOW_SIZE + (id == null ? 0 : id.length()) + (source == null ? 0 : source.length());
    }
