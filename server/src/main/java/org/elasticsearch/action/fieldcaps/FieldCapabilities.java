...
public class FieldCapabilities implements Writeable, ToXContentObject {
    ...
    static class Builder {
        ...
        FieldCapabilities build(boolean withIndices) {
            final String[] indices = withIndices ? filterIndices(totalIndices, Predicates.alwaysTrue()) : null;
            ...
            if (hasConflictMetricType) {
                ...
                metricConflictsIndices = Objects.requireNonNullElseGet(indices, () -> filterIndices(totalIndices, Predicates.alwaysTrue()));
            } else {
