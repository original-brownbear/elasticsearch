...
public final class TransportRemoteInfoAction extends HandledTransportAction<RemoteInfoRequest, RemoteInfoResponse> {
    ...
    public static final ActionType<RemoteInfoResponse> ACTION = new ActionType<>("cluster:monitor/remote/info", RemoteInfoResponse::new);
    ...
    public TransportRemoteInfoAction(
        ...
        super(ACTION.name(), transportService, actionFilters, RemoteInfoRequest::new);
