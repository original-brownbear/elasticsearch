...
public class GetAliasesResponse extends ActionResponse {
    ...
    public void writeTo(StreamOutput out) throws IOException {
        out.writeMap(aliases, (streamOutput1, list1) -> streamOutput1.writeCollection(list1));
        out.writeMap(dataStreamAliases, (streamOutput, list) -> streamOutput.writeCollection(list));
    }
