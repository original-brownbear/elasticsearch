...
public class GetSettingsResponse extends ActionResponse implements ToXContentObject {
    ...
    public GetSettingsResponse(StreamInput in) throws IOException {
        super(in);
        indexToSettings = in.readImmutableStringKeyedMap(Settings::readSettingsFromStream);
        indexToDefaultSettings = in.readImmutableStringKeyedMap(Settings::readSettingsFromStream);
    }
