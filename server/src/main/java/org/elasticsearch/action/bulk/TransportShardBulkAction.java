...
public class TransportShardBulkAction extends TransportWriteAction<BulkShardRequest, BulkShardRequest, BulkShardResponse> {
    ...
    static boolean executeBulkItemRequest(
        ...
        if (opType == DocWriteRequest.OpType.UPDATE) {
            updateResult = applyUpdate(context, updateHelper, nowInMillisSupplier);
        ...
        if (context.getRequestToExecute().opType() == DocWriteRequest.OpType.DELETE) {
            result = applyDelete(context, primary, version);
        } else {
            result = applyWrite(context, primary, version);
            if (result.getResultType() == Engine.Result.Type.MAPPING_UPDATE_REQUIRED) {
                return handleRequiredMappingUpdate(
                    context,
                    mappingUpdater,
                    waitForMappingUpdate,
                    itemDoneListener,
    ...
    private static UpdateHelper.Result applyUpdate(
        BulkPrimaryExecutionContext context,
        UpdateHelper updateHelper,
        LongSupplier nowInMillisSupplier
    ) {
        ...
        try {
            ...
            handleUpdatePrepareException(context, updateRequest, failure);
            return null;
        }
    ...
    private static Engine.Result applyWrite(BulkPrimaryExecutionContext context, IndexShard primary, long version) throws IOException {
        final Engine.Result result;
    ...
    private static Engine.Result applyDelete(BulkPrimaryExecutionContext context, IndexShard primary, long version) throws IOException {
        final Engine.Result result;
    ...
    private static boolean handleRequiredMappingUpdate(
        BulkPrimaryExecutionContext context,
        MappingUpdatePerformer mappingUpdater,
        Consumer<ActionListener<Void>> waitForMappingUpdate,
        ActionListener<Void> itemDoneListener,
        ...
        try {
            ...
            handleRejectedMappingUpdate(context, updateResult, primary, version, result, e);
            return true;
        }
    ...
    private static void handleRejectedMappingUpdate(
        BulkPrimaryExecutionContext context,
        UpdateHelper.Result updateResult,
        IndexShard primary,
        long version,
    ...
    private static void handleUpdatePrepareException(BulkPrimaryExecutionContext context, UpdateRequest updateRequest, Exception failure) {
