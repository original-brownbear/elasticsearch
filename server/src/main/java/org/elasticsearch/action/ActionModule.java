...
public class ActionModule extends AbstractModule {
    ...
    public void initRestHandlers(Supplier<DiscoveryNodes> nodesInCluster) {
        ...
        registerHandler.accept(RestAddVotingConfigExclusionAction.INSTANCE);
        registerHandler.accept(RestClearVotingConfigExclusionsAction.INSTANCE);
        registerHandler.accept(new RestMainAction());
        registerHandler.accept(new RestNodesInfoAction(settingsFilter));
        registerHandler.accept(RestRemoteClusterInfoAction.INSTANCE);
        registerHandler.accept(RestNodesStatsAction.INSTANCE);
        registerHandler.accept(RestNodesUsageAction.INSTANCE);
        registerHandler.accept(RestNodesHotThreadsAction.INSTANCE);
        registerHandler.accept(RestClusterAllocationExplainAction.INSTANCE);
        registerHandler.accept(RestClusterStatsAction.INSTANCE);
        registerHandler.accept(new RestClusterStateAction(settingsFilter));
        registerHandler.accept(RestClusterHealthAction.INSTANCE);
        ...
        registerHandler.accept(RestClusterSearchShardsAction.INSTANCE);
        registerHandler.accept(RestPendingClusterTasksAction.INSTANCE);
        registerHandler.accept(RestPutRepositoryAction.INSTANCE);
        ...
        registerHandler.accept(RestIndicesStatsAction.INSTANCE);
