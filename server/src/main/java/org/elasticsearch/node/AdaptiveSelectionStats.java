...
public class AdaptiveSelectionStats implements Writeable, ToXContentFragment {
    ...
    public AdaptiveSelectionStats(StreamInput in) throws IOException {
        this.clientOutgoingConnections = in.readStringKeyMap(StreamInput::readLong);
        this.nodeComputedStats = in.readStringKeyMap(ResponseCollectorService.ComputedNodeStats::new);
    }
