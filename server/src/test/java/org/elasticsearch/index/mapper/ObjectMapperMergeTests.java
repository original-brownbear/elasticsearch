...
public class ObjectMapperMergeTests extends ESTestCase {
    ...
    public void testMergeDisabledField() {
        ...
        RootObjectMapper mergeWith = new RootObjectMapper.Builder(Explicit.IMPLICIT_TRUE).add(
    ...
    public void testMergeEnabledForRootMapper() {
        ...
        ObjectMapper firstMapper = new RootObjectMapper.Builder(Explicit.IMPLICIT_TRUE).build(MapperBuilderContext.root(false, false));
        ObjectMapper secondMapper = new RootObjectMapper.Builder(Explicit.IMPLICIT_TRUE).enabled(false)
            .build(MapperBuilderContext.root(false, false));
    ...
    public void testMergeDisabledRootMapper() {
        final RootObjectMapper rootObjectMapper = (RootObjectMapper) new RootObjectMapper.Builder(ObjectMapper.Defaults.SUBOBJECTS).enabled(
            false
        ).build(MapperBuilderContext.root(false, false));
        // the root is disabled, and we are not trying to re-enable it, but we do want to be able to add runtime fields
        final RootObjectMapper mergeWith = new RootObjectMapper.Builder(ObjectMapper.Defaults.SUBOBJECTS).addRuntimeFields(
    ...
    public void testMergedFieldNamesFieldWithDotsSubobjectsFalse() {
        RootObjectMapper mergeInto = new RootObjectMapper.Builder(Explicit.IMPLICIT_TRUE).add(createObjectSubobjectsFalseLeafWithDots())
            .build(MapperBuilderContext.root(false, false));
        RootObjectMapper mergeWith = new RootObjectMapper.Builder(Explicit.IMPLICIT_TRUE).add(createObjectSubobjectsFalseLeafWithDots())
            .build(MapperBuilderContext.root(false, false));
    ...
    public void testMergedFieldNamesMultiFields() {
        RootObjectMapper mergeInto = new RootObjectMapper.Builder(Explicit.IMPLICIT_TRUE).add(createTextKeywordMultiField("text"))
            .build(MapperBuilderContext.root(false, false));
        RootObjectMapper mergeWith = new RootObjectMapper.Builder(Explicit.IMPLICIT_TRUE).add(createTextKeywordMultiField("text"))
            .build(MapperBuilderContext.root(false, false));
    ...
    public void testMergedFieldNamesMultiFieldsWithinSubobjectsFalse() {
        RootObjectMapper mergeInto = new RootObjectMapper.Builder(Explicit.IMPLICIT_TRUE).add(
    ...
    private static RootObjectMapper createRootSubobjectFalseLeafWithDots() {
        ...
        return new RootObjectMapper.Builder(Explicit.EXPLICIT_FALSE).add(fieldBuilder).build(MapperBuilderContext.root(false, false));
    }
