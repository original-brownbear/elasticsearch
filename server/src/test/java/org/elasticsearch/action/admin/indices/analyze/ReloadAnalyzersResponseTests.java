...
public class ReloadAnalyzersResponseTests extends AbstractBroadcastResponseTestCase<ReloadAnalyzersResponse> {
    ...
    static {
        @SuppressWarnings({ "unchecked" })
        final ConstructingObjectParser<ReloadAnalyzersResponse.ReloadDetails, Void> entryParser = new ConstructingObjectParser<>(
        ...
        PARSER.declareObjectArray(constructorArg(), entryParser, ReloadAnalyzersResponse.RELOAD_DETAILS_FIELD);
        entryParser.declareString(constructorArg(), ReloadAnalyzersResponse.INDEX_FIELD);
        entryParser.declareStringArray(constructorArg(), ReloadAnalyzersResponse.RELOADED_ANALYZERS_FIELD);
        entryParser.declareStringArray(constructorArg(), ReloadAnalyzersResponse.RELOADED_NODE_IDS_FIELD);
    }
