...
public class ListTasksResponseTests extends AbstractXContentTestCase<ListTasksResponseTests.ListTasksResponseWrapper> {
    ...
    public static <T> ConstructingObjectParser<T, Void> setupParser(
        String name,
        ...
        parser.declareObjectArray(
            ...
            new ParseField(ListTasksResponse.TASK_FAILURES)
        );
        parser.declareObjectArray(
            optionalConstructorArg(),
            (p, c) -> ElasticsearchException.fromXContent(p),
            new ParseField(ListTasksResponse.NODE_FAILURES)
        );
        return parser;
    }
