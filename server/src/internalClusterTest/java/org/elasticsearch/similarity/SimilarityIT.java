...
public class SimilarityIT extends ESIntegTestCase {
    public void testCustomBM25Similarity() throws Exception {
        ...
        assertResponse(bm25SearchResponse -> {
            ...
            assertResponse(booleanSearchResponse -> {
            ...
            }, prepareSearch().setQuery(matchQuery("field2", "quick brown fox")));
        }, prepareSearch().setQuery(matchQuery("field1", "quick brown fox")));
    }
}
