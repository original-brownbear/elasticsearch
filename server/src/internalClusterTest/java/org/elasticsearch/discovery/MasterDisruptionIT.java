...
public class MasterDisruptionIT extends AbstractDisruptionTestCase {
    ...
    public void testIsolateMasterAndVerifyClusterStateConsensus() throws Exception {
        ...
        assertAcked(prepareCreate("test").setSettings(shardsAndReplicas(1 + randomInt(2), randomInt(2))));
    ...
    public void testVerifyApiBlocksDuringPartition() throws Exception {
        ...
        assertAcked(prepareCreate("test").setSettings(shardsAndReplicas(1, 2)));
    ...
    public void testMappingTimeout() throws Exception {
        ...
        createIndex(
            "test",
            shardsAndReplicas(1, 1).put("index.routing.allocation.exclude._name", internalCluster().getMasterName()).build()
        );
