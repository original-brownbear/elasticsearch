...
public class RestoreSnapshotIT extends AbstractSnapshotIntegTestCase {
    ...
    public void testChangeSettingsOnRestore() throws Exception {
        ...
        assertHitCount(numdocs, client.prepareSearch("test-idx").setSize(0).setQuery(matchQuery("field1", "foo")));
        assertHitCount(0, client.prepareSearch("test-idx").setSize(0).setQuery(matchQuery("field1", "Foo")));
        assertHitCount(numdocs, client.prepareSearch("test-idx").setSize(0).setQuery(matchQuery("field1", "bar")));
