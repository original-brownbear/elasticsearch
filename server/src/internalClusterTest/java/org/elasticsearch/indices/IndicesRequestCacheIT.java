...
public class IndicesRequestCacheIT extends ESIntegTestCase {
    ...
    public void testQueryRewrite() throws Exception {
        ...
        assertAcked(
            client.admin()
                ...
                .setSettings(
                    shardsAndReplicas(5, 0).put(IndicesRequestCache.INDEX_CACHE_REQUEST_ENABLED_SETTING.getKey(), true)
    ...
    public void testQueryRewriteMissingValues() throws Exception {
        ...
        assertAcked(
            client.admin()
                ...
                .prepareCreate("index")
                .setMapping("s", "type=date")
                .setSettings(shardsAndReplicas(1, 0).put(IndicesRequestCache.INDEX_CACHE_REQUEST_ENABLED_SETTING.getKey(), true))
                .get()
        );
        indexRandom(
            true,
    ...
    public void testQueryRewriteDatesWithNow() throws Exception {
        Client client = client();
        Settings settings = shardsAndReplicas(1, 0).put(IndicesRequestCache.INDEX_CACHE_REQUEST_ENABLED_SETTING.getKey(), true).build();
    ...
    public void testCanCache() throws Exception {
        Client client = client();
        Settings settings = shardsAndReplicas(2, 0).put(IndicesRequestCache.INDEX_CACHE_REQUEST_ENABLED_SETTING.getKey(), true)
