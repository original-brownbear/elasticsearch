...
public class UpdateSettingsIT extends ESIntegTestCase {
    ...
    public void testInvalidDynamicUpdate() {
        ...
        IndexMetadata indexMetadata = getState().metadata().index("test");
    ...
    public void testResetDefaultWithWildcard() {
        ...
        client().admin()
            ...
            .execute()
            .actionGet();
        indexMetadata = getState().metadata().index("test");
    ...
    public void testSettingsVersion() {
...

        {
            ...
            final long newSettingsVersion = getState().metadata().index("test").getSettingsVersion();
