...
public class IndexTemplateBlocksIT extends ESIntegTestCase {
    public void testIndexTemplatesWithBlocks() throws IOException {
        ...
        try {
            ...
            GetIndexTemplatesResponse response = admin().indices().prepareGetTemplates("template_blocks").execute().actionGet();
            ...
            assertBlocked(admin().indices().prepareDeleteTemplate("template_blocks"));
