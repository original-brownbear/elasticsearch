...
public class RareClusterStateIT extends ESIntegTestCase {
    ...
    public void testDelayedMappingPropagationOnPrimary() throws Exception {
        ...
        assertAcked(
            prepareCreate("index").setSettings(shardsAndReplicas(1, 0).put("index.routing.allocation.exclude._name", master)).get()
        );
        ensureGreen();
    ...
    public void testDelayedMappingPropagationOnReplica() throws Exception {
        ...
        prepareCreate("index").setSettings(shardsAndReplicas(1, 1).put("index.routing.allocation.include._name", master)).get();
