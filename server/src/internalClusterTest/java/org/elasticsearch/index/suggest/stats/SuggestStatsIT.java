...
public class SuggestStatsIT extends ESIntegTestCase {
    ...
    public void testSimpleStats() throws Exception {
        ...
        assertAcked(prepareCreate("test1").setSettings(shardsAndReplicas(shardsIdx1, 0)).setMapping("f", "type=text"));
        assertAcked(prepareCreate("test2").setSettings(shardsAndReplicas(shardsIdx2, 0)).setMapping("f", "type=text"));
