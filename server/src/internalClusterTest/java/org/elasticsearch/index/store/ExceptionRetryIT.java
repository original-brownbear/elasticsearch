...
public class ExceptionRetryIT extends ESIntegTestCase {
    ...
    public void testRetryDueToExceptionOnNetworkLayer() throws ExecutionException, InterruptedException, IOException {
        ...
        assertAcked(admin().indices().prepareCreate("index").setSettings(indexSettings(5, 1)));
        ensureGreen("index");
        ...
        IndicesStatsResponse index = admin().indices().prepareStats("index").clear().setSegments(true).get();
