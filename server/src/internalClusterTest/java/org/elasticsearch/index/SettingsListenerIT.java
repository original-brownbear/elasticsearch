...
public class SettingsListenerIT extends ESIntegTestCase {
    ...
    public void testListener() {
        assertAcked(indicesAdmin().prepareCreate("test").setSettings(Settings.builder().put("index.test.new.setting", 21)).get());
        ...
        assertAcked(indicesAdmin().prepareCreate("other").setSettings(Settings.builder().put("index.test.new.setting", 21)).get());
