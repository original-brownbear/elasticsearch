...
public class SearchPreferenceIT extends ESIntegTestCase {
    ...
    public void testCustomPreferenceUnaffectedByOtherShardMovements() {
        ...
        updateIndexSettings("test2", indexSettingsWithReplicas(replicasInNewIndex - 1));

        assertSearchesSpecificNode("test", customPreference, nodeId);

        updateIndexSettings("test2", indexSettingsWithReplicas(0).put(IndexMetadata.INDEX_ROUTING_REQUIRE_GROUP_PREFIX + "._name",
