...
public class SearchFieldsIT extends ESIntegTestCase {
    ...
    public void testStoredFields() throws Exception {
        ...
        admin().indices().preparePutMapping().setSource(mapping, XContentType.JSON).get();
    ...
    public void testSingleValueFieldDatatField() throws ExecutionException, InterruptedException {
        assertAcked(admin().indices().prepareCreate("test").setMapping("test_field", "type=keyword").get());
