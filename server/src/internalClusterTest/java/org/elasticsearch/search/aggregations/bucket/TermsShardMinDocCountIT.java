...
public class TermsShardMinDocCountIT extends ESIntegTestCase {
    ...
    public void testShardMinDocCountSignificantTermsTest() throws Exception {
        ...
        assertAcked(prepareCreate(index).setSettings(shardsAndReplicas(1, 0)).setMapping("text", textMappings));
    ...
    public void testShardMinDocCountTermsTest() throws Exception {
        ...
        assertAcked(prepareCreate(index).setSettings(shardsAndReplicas(1, 0)).setMapping("text", termMappings));
        List<IndexRequestBuilder> indexBuilders = new ArrayList<>();
