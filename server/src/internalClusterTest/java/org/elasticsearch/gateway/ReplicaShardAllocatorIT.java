    ...
    public void testPreferCopyCanPerformNoopRecovery() throws Exception {
        ...
        assertAcked(
            client().admin()
                ...
                .setSettings(
                    shardsAndReplicas(1, 1).put(IndexSettings.FILE_BASED_RECOVERY_THRESHOLD_SETTING.getKey(), 1.0f)
    ...
    public void testRecentPrimaryInformation() throws Exception {
        ...
        assertAcked(
            client().admin()
                ...
                .prepareCreate(indexName)
                .setSettings(
                    shardsAndReplicas(1, 1).put(IndexSettings.FILE_BASED_RECOVERY_THRESHOLD_SETTING.getKey(), 0.1f)
                        .put(IndexService.GLOBAL_CHECKPOINT_SYNC_INTERVAL_SETTING.getKey(), "100ms")
                        .put(IndexService.RETENTION_LEASE_SYNC_INTERVAL_SETTING.getKey(), "100ms")
                        .put(UnassignedInfo.INDEX_DELAYED_NODE_LEFT_TIMEOUT_SETTING.getKey(), "1ms")
                )
    ...
    public void testFullClusterRestartPerformNoopRecovery() throws Exception {
        ...
        assertAcked(
            client().admin()
                ...
                .prepareCreate(indexName)
                .setSettings(
                    shardsAndReplicas(1, numOfReplicas).put(
    ...
    public void testDoNotCancelRecoveryForBrokenNode() throws Exception {
        ...
        assertAcked(
            client().admin()
                ...
                .prepareCreate(indexName)
                .setSettings(
                    shardsAndReplicas(1, 0).put(IndexService.GLOBAL_CHECKPOINT_SYNC_INTERVAL_SETTING.getKey(), "100ms")
                        .put(IndexService.RETENTION_LEASE_SYNC_INTERVAL_SETTING.getKey(), "100ms")
                )
        );
        indexRandom(
