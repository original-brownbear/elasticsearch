...
public class ReplicaShardAllocatorSyncIdIT extends ESIntegTestCase {
    ...
    public void testPreferCopyCanPerformNoopRecovery() throws Exception {
        ...
        assertAcked(
            client().admin().indices().prepareCreate(indexName).setSettings(indexSettingsWithShardsAndReplicas(1, 1)
    ...
    public void testFullClusterRestartPerformNoopRecovery() throws Exception {
        ...
        String indexName = "test";
        assertAcked(
            client().admin().indices().prepareCreate(indexName).setSettings(indexSettingsWithShardsAndReplicas(1, numOfReplicas)
