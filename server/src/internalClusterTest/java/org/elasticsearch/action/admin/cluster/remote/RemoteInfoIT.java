...
public class RemoteInfoIT extends AbstractMultiClustersTestCase {
    ...
    public void testRemoteClusterClientRole() {
        ...
        localCluster.client().execute(TransportRemoteInfoAction.ACTION, new RemoteInfoRequest()).actionGet();
        ...
        final IllegalArgumentException error = expectThrows(
            ...
            () -> localCluster.client(nodeWithoutRemoteClientRole)
                .execute(TransportRemoteInfoAction.ACTION, new RemoteInfoRequest())
                .actionGet()
        );
        assertThat(
            error.getMessage(),
        ...
        localCluster.client(nodeWithRemoteClientRole).execute(TransportRemoteInfoAction.ACTION, new RemoteInfoRequest()).actionGet();
    }
