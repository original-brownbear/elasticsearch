...
public class IndicesSegmentsBlocksIT extends ESIntegTestCase {
    public void testIndicesSegmentsWithBlocks() {
        ...
        admin().indices().prepareFlush("test-blocks").get();
        ...
        for (String blockSetting : Arrays.asList(
            ...
            try {
                ...
                IndicesSegmentResponse response = admin().indices().prepareSegments("test-blocks").execute().actionGet();
        ...
        try {
            ...
            assertBlocked(admin().indices().prepareSegments("test-blocks"));
        } finally {
